...
///////////////////////////////////////////////////////////
const newCounterpartie = (
	syncParams: ISyncParams,
	iikoCounterpartie: IiikoCounterpartie,
) => {
	return {
...
///////////////////////////////////////////////////////////
async function syncCounterpartie(
	syncParams: ISyncParams,
	iikoCounterpartie: IiikoCounterpartie,
	destSQL: SQLClient,
): Promise<any> {
...
export async function ImportCounterpartieToJetti(syncParams: ISyncParams) {
	await saveLogProtocol(
		...
		0,
		syncStage,
		`Start sync Counterparties`,
	);
	if (syncParams.baseType === 'sql')
		await ImportCounterpartieSQLToJetti(syncParams);
}
///////////////////////////////////////////////////////////
