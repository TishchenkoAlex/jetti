      ...
      GO
      CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.AccountablePersons.TO] ON [dbo].[Register.Accumulation.AccountablePersons.TO.v] ([date], [company], [currency], [Employee], [CashFlow]) WITH(ONLINE = ON);-- ON PS_month([date]);
      GO
      ...
      GO
      CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.PaymentBatch.TO] ON [dbo].[Register.Accumulation.PaymentBatch.TO.v] ([date], [company], [PaymentsKind], [Counterpartie], [ProductPackage], [Product], [Currency], [batch]) WITH(ONLINE = ON);-- ON PS_month([date]);
      GO
      ...
      GO
      CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.OrderPayment.TO] ON [dbo].[Register.Accumulation.OrderPayment.TO.v] ([date], [company], [PaymantKind], [Customer], [BankAccount], [CashRegister], [AcquiringTerminal], [currency], [Department]) WITH(ONLINE = ON);-- ON PS_month([date]);
      GO
      ...
      GO
      CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.AP.TO] ON [dbo].[Register.Accumulation.AP.TO.v] ([date], [company], [currency], [AO], [Supplier]) WITH(ONLINE = ON);-- ON PS_month([date]);
      GO
      ...
      GROUP BY
        ...
        , TRY_CONVERT(UNIQUEIDENTIFIER, JSON_VALUE(data, N'$."Customer"'))
      GO
      CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.AR.TO] ON [dbo].[Register.Accumulation.AR.TO.v] ([date], [company], [currency], [AO], [Customer]) WITH(ONLINE = ON);-- ON PS_month([date]);
      GO
      ...
      GO
      CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.Bank.TO] ON [dbo].[Register.Accumulation.Bank.TO.v] ([date], [company], [currency], [BankAccount], [CashFlow], [Analytics]) WITH(ONLINE = ON);-- ON PS_month([date]);
      GO
      ...
      GROUP BY
        ...
        , TRY_CONVERT(UNIQUEIDENTIFIER, JSON_VALUE(data, N'$."Analytics"'))
      GO
      CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.Balance.TO] ON [dbo].[Register.Accumulation.Balance.TO.v] ([date], [company], [Balance], [Analytics]) WITH(ONLINE = ON);-- ON PS_month([date]);
      GO
      ...
      GROUP BY
        ...
        , TRY_CONVERT(UNIQUEIDENTIFIER, JSON_VALUE(data, N'$."Currency"'))
      GO
      CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.Balance.RC.TO] ON [dbo].[Register.Accumulation.Balance.RC.TO.v] ([date], [company], [ResponsibilityCenter], [Department], [Balance], [Analytics], [Analytics2], [Currency]) WITH(ONLINE = ON);-- ON PS_month([date]);
      GO
      ...
      GROUP BY
        ...
        , TRY_CONVERT(UNIQUEIDENTIFIER, JSON_VALUE(data, N'$."Analytics"'))
      GO
      CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.Balance.Report.TO] ON [dbo].[Register.Accumulation.Balance.Report.TO.v] ([date], [company], [currency], [Balance], [Analytics]) WITH(ONLINE = ON);-- ON PS_month([date]);
      GO
      ...
      GROUP BY
        ...
        , TRY_CONVERT(UNIQUEIDENTIFIER, JSON_VALUE(data, N'$."Analytics"'))
      GO
      CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.Cash.TO] ON [dbo].[Register.Accumulation.Cash.TO.v] ([date], [company], [currency], [CashRegister], [CashFlow], [Analytics]) WITH(ONLINE = ON);-- ON PS_month([date]);
      GO
      ...
      GROUP BY
        ...
        , TRY_CONVERT(UNIQUEIDENTIFIER, JSON_VALUE(data, N'$."CashFlow"'))
      GO
      CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.Cash.Transit.TO] ON [dbo].[Register.Accumulation.Cash.Transit.TO.v] ([date], [company], [CompanyRecipient], [currency], [Sender], [Recipient], [CashFlow]) WITH(ONLINE = ON);-- ON PS_month([date]);
      GO
      ...
      GO
      CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.Inventory.TO] ON [dbo].[Register.Accumulation.Inventory.TO.v] ([date], [company], [Storehouse], [SKU]) WITH(ONLINE = ON);-- ON PS_month([date]);
      GO
      ...
      GROUP BY
        ...
        , TRY_CONVERT(UNIQUEIDENTIFIER, JSON_VALUE(data, N'$."currency"'))
      GO
      CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.Loan.TO] ON [dbo].[Register.Accumulation.Loan.TO.v] ([date], [company], [Loan], [Counterpartie], [CashFlow], [currency]) WITH(ONLINE = ON);-- ON PS_month([date]);
      GO
      ...
      GROUP BY
        ...
        , TRY_CONVERT(UNIQUEIDENTIFIER, JSON_VALUE(data, N'$."Analytics2"'))
      GO
      CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.PL.TO] ON [dbo].[Register.Accumulation.PL.TO.v] ([date], [company], [Department], [PL], [Analytics], [Analytics2]) WITH(ONLINE = ON);-- ON PS_month([date]);
      GO
      ...
      GROUP BY
        ...
        , TRY_CONVERT(UNIQUEIDENTIFIER, JSON_VALUE(data, N'$."Currency"'))
      GO
      CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.PL.RC.TO] ON [dbo].[Register.Accumulation.PL.RC.TO.v] ([date], [company], [ResponsibilityCenter], [Department], [PL], [Analytics], [Analytics2], [Currency]) WITH(ONLINE = ON);-- ON PS_month([date]);
      GO
      ...
      GROUP BY
        ...
        , TRY_CONVERT(UNIQUEIDENTIFIER, JSON_VALUE(data, N'$."Storehouse"'))
      GO
      CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.Sales.TO] ON [dbo].[Register.Accumulation.Sales.TO.v] ([date], [company], [currency], [Department], [Customer], [Product], [Analytic], [Manager], [Storehouse]) WITH(ONLINE = ON);-- ON PS_month([date]);
      GO
      ...
      GO
      CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.Salary.TO] ON [dbo].[Register.Accumulation.Salary.TO.v] ([date], [company], [currency], [KorrCompany], [Department], [Person], [Employee], [SalaryKind], [Analytics], [PL], [PLAnalytics], [Status]) WITH(ONLINE = ON);-- ON PS_month([date]);
      GO
      ...
      GO
      CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.Depreciation.TO] ON [dbo].[Register.Accumulation.Depreciation.TO.v] ([date], [company], [OperationType], [currency], [Department], [ResponsiblePerson]) WITH(ONLINE = ON);-- ON PS_month([date]);
      GO
      ...
      GROUP BY
        ...
        , TRY_CONVERT(UNIQUEIDENTIFIER, JSON_VALUE(data, N'$."currency"'))
      GO
      CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.BudgetItemTurnover.TO] ON [dbo].[Register.Accumulation.BudgetItemTurnover.TO.v] ([date], [company], [Department], [Scenario], [BudgetItem], [currency]) WITH(ONLINE = ON);-- ON PS_month([date]);
      GO
      ...
      GO
      CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.Intercompany.TO] ON [dbo].[Register.Accumulation.Intercompany.TO.v] ([date], [company], [Intercompany], [LegalCompanySender], [LegalCompanyRecipient]) WITH(ONLINE = ON);-- ON PS_month([date]);
      GO
      ...
      GROUP BY
        ...
        , TRY_CONVERT(UNIQUEIDENTIFIER, JSON_VALUE(data, N'$."currency"'))
      GO
      CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.Acquiring.TO] ON [dbo].[Register.Accumulation.Acquiring.TO.v] ([date], [company], [AcquiringTerminal], [OperationType], [Department], [CashFlow], [currency]) WITH(ONLINE = ON);-- ON PS_month([date]);
      GO
      ...
      GROUP BY
        ...
        , TRY_CONVERT(UNIQUEIDENTIFIER, JSON_VALUE(data, N'$."currency"'))
      GO
      CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.StaffingTable.TO] ON [dbo].[Register.Accumulation.StaffingTable.TO.v] ([date], [company], [Department], [DepartmentCompany], [StaffingTablePosition], [Employee], [Person], [SalaryAnalytic], [currency]) WITH(ONLINE = ON);-- ON PS_month([date]);
      GO
