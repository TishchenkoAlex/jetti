...
------------------------------ BEGIN Register.Accumulation.AccountablePersons ------------------------------
    ...
    BEGIN
      SET NOCOUNT ON;
      DECLARE @COUNT_D INT = (SELECT COUNT(*) FROM deleted WHERE type = N'Register.Accumulation.AccountablePersons');
...
------------------------------ BEGIN Register.Accumulation.PaymentBatch ------------------------------
    ...
    BEGIN
      SET NOCOUNT ON;
      DECLARE @COUNT_D INT = (SELECT COUNT(*) FROM deleted WHERE type = N'Register.Accumulation.PaymentBatch');
...
------------------------------ BEGIN Register.Accumulation.Investment.Analytics ------------------------------
    ...
    BEGIN
      SET NOCOUNT ON;
      DECLARE @COUNT_D INT = (SELECT COUNT(*) FROM deleted WHERE type = N'Register.Accumulation.Investment.Analytics');
...
------------------------------ BEGIN Register.Accumulation.OrderPayment ------------------------------
    ...
    BEGIN
      SET NOCOUNT ON;
      DECLARE @COUNT_D INT = (SELECT COUNT(*) FROM deleted WHERE type = N'Register.Accumulation.OrderPayment');
...
------------------------------ BEGIN Register.Accumulation.AP ------------------------------
    ...
    BEGIN
      SET NOCOUNT ON;
      DECLARE @COUNT_D INT = (SELECT COUNT(*) FROM deleted WHERE type = N'Register.Accumulation.AP');
...
------------------------------ BEGIN Register.Accumulation.AR ------------------------------
    ...
    BEGIN
      SET NOCOUNT ON;
      DECLARE @COUNT_D INT = (SELECT COUNT(*) FROM deleted WHERE type = N'Register.Accumulation.AR');
...
------------------------------ BEGIN Register.Accumulation.Bank ------------------------------
    ...
    BEGIN
      SET NOCOUNT ON;
      DECLARE @COUNT_D INT = (SELECT COUNT(*) FROM deleted WHERE type = N'Register.Accumulation.Bank');
...
------------------------------ BEGIN Register.Accumulation.Balance ------------------------------
    ...
    BEGIN
      SET NOCOUNT ON;
      DECLARE @COUNT_D INT = (SELECT COUNT(*) FROM deleted WHERE type = N'Register.Accumulation.Balance');
...
------------------------------ BEGIN Register.Accumulation.Balance.RC ------------------------------
    ...
    BEGIN
      SET NOCOUNT ON;
      DECLARE @COUNT_D INT = (SELECT COUNT(*) FROM deleted WHERE type = N'Register.Accumulation.Balance.RC');
...
------------------------------ BEGIN Register.Accumulation.Balance.Report ------------------------------
    ...
    BEGIN
      SET NOCOUNT ON;
      DECLARE @COUNT_D INT = (SELECT COUNT(*) FROM deleted WHERE type = N'Register.Accumulation.Balance.Report');
...
------------------------------ BEGIN Register.Accumulation.Cash ------------------------------
    ...
    BEGIN
      SET NOCOUNT ON;
      DECLARE @COUNT_D INT = (SELECT COUNT(*) FROM deleted WHERE type = N'Register.Accumulation.Cash');
...
------------------------------ BEGIN Register.Accumulation.Cash.Transit ------------------------------
    ...
    BEGIN
      SET NOCOUNT ON;
      DECLARE @COUNT_D INT = (SELECT COUNT(*) FROM deleted WHERE type = N'Register.Accumulation.Cash.Transit');
...
------------------------------ BEGIN Register.Accumulation.EmployeeTimekeeping ------------------------------
    ...
    BEGIN
      SET NOCOUNT ON;
      DECLARE @COUNT_D INT = (SELECT COUNT(*) FROM deleted WHERE type = N'Register.Accumulation.EmployeeTimekeeping');
...
------------------------------ BEGIN Register.Accumulation.Inventory ------------------------------
    ...
    BEGIN
      SET NOCOUNT ON;
      DECLARE @COUNT_D INT = (SELECT COUNT(*) FROM deleted WHERE type = N'Register.Accumulation.Inventory');
...
------------------------------ BEGIN Register.Accumulation.Loan ------------------------------
    ...
    BEGIN
      SET NOCOUNT ON;
      DECLARE @COUNT_D INT = (SELECT COUNT(*) FROM deleted WHERE type = N'Register.Accumulation.Loan');
...
------------------------------ BEGIN Register.Accumulation.PL ------------------------------
    ...
    BEGIN
      SET NOCOUNT ON;
      DECLARE @COUNT_D INT = (SELECT COUNT(*) FROM deleted WHERE type = N'Register.Accumulation.PL');
...
------------------------------ BEGIN Register.Accumulation.PL.RC ------------------------------
    ...
    BEGIN
      SET NOCOUNT ON;
      DECLARE @COUNT_D INT = (SELECT COUNT(*) FROM deleted WHERE type = N'Register.Accumulation.PL.RC');
...
------------------------------ BEGIN Register.Accumulation.Sales ------------------------------
    ...
    BEGIN
      SET NOCOUNT ON;
      DECLARE @COUNT_D INT = (SELECT COUNT(*) FROM deleted WHERE type = N'Register.Accumulation.Sales');
...
------------------------------ BEGIN Register.Accumulation.Salary ------------------------------
    ...
    BEGIN
      SET NOCOUNT ON;
      DECLARE @COUNT_D INT = (SELECT COUNT(*) FROM deleted WHERE type = N'Register.Accumulation.Salary');
...
------------------------------ BEGIN Register.Accumulation.Depreciation ------------------------------
    ...
    BEGIN
      SET NOCOUNT ON;
      DECLARE @COUNT_D INT = (SELECT COUNT(*) FROM deleted WHERE type = N'Register.Accumulation.Depreciation');
...
------------------------------ BEGIN Register.Accumulation.CashToPay ------------------------------
    ...
    BEGIN
      SET NOCOUNT ON;
      DECLARE @COUNT_D INT = (SELECT COUNT(*) FROM deleted WHERE type = N'Register.Accumulation.CashToPay');
...
------------------------------ BEGIN Register.Accumulation.BudgetItemTurnover ------------------------------
    ...
    BEGIN
      SET NOCOUNT ON;
      DECLARE @COUNT_D INT = (SELECT COUNT(*) FROM deleted WHERE type = N'Register.Accumulation.BudgetItemTurnover');
...
------------------------------ BEGIN Register.Accumulation.Intercompany ------------------------------
    ...
    BEGIN
      SET NOCOUNT ON;
      DECLARE @COUNT_D INT = (SELECT COUNT(*) FROM deleted WHERE type = N'Register.Accumulation.Intercompany');
...
------------------------------ BEGIN Register.Accumulation.Acquiring ------------------------------
    ...
    BEGIN
      SET NOCOUNT ON;
      DECLARE @COUNT_D INT = (SELECT COUNT(*) FROM deleted WHERE type = N'Register.Accumulation.Acquiring');
...
------------------------------ BEGIN Register.Accumulation.StaffingTable ------------------------------
    ...
    BEGIN
      SET NOCOUNT ON;
      DECLARE @COUNT_D INT = (SELECT COUNT(*) FROM deleted WHERE type = N'Register.Accumulation.StaffingTable');
