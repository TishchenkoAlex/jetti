...
------------------------------ BEGIN Operation.LOAD_SALARY ------------------------------
      ...
      SELECT
        ...
        , ISNULL(l5.description, d.description) [LOAD_SALARY.Level5]
        , ISNULL(l4.description, ISNULL(l5.description, d.description)) [LOAD_SALARY.Level4]
        , ISNULL(l3.description, ISNULL(l4.description, ISNULL(l5.description, d.description))) [LOAD_SALARY.Level3]
        , ISNULL(l2.description, ISNULL(l3.description, ISNULL(l4.description, ISNULL(l5.description, d.description)))) [LOAD_SALARY.Level2]
        , ISNULL(l1.description, ISNULL(l2.description, ISNULL(l3.description, ISNULL(l4.description, ISNULL(l5.description, d.description))))) [LOAD_SALARY.Level1]
      FROM [Operation.LOAD_SALARY.v] d WITH (NOEXPAND)
        LEFT JOIN [Operation.LOAD_SALARY.v] l5 WITH (NOEXPAND) ON (l5.id = d.parent)
        LEFT JOIN [Operation.LOAD_SALARY.v] l4 WITH (NOEXPAND) ON (l4.id = l5.parent)
        LEFT JOIN [Operation.LOAD_SALARY.v] l3 WITH (NOEXPAND) ON (l3.id = l4.parent)
        LEFT JOIN [Operation.LOAD_SALARY.v] l2 WITH (NOEXPAND) ON (l2.id = l3.parent)
        LEFT JOIN [Operation.LOAD_SALARY.v] l1 WITH (NOEXPAND) ON (l1.id = l2.parent)
...
------------------------------ BEGIN Operation.SPECIFICATION ------------------------------
      ...
      FROM [Operation.SPECIFICATION.v] d WITH (NOEXPAND)
        LEFT JOIN [Operation.SPECIFICATION.v] l5 WITH (NOEXPAND) ON (l5.id = d.parent)
        LEFT JOIN [Operation.SPECIFICATION.v] l4 WITH (NOEXPAND) ON (l4.id = l5.parent)
        LEFT JOIN [Operation.SPECIFICATION.v] l3 WITH (NOEXPAND) ON (l3.id = l4.parent)
        LEFT JOIN [Operation.SPECIFICATION.v] l2 WITH (NOEXPAND) ON (l2.id = l3.parent)
        LEFT JOIN [Operation.SPECIFICATION.v] l1 WITH (NOEXPAND) ON (l1.id = l2.parent)
...
------------------------------ BEGIN Operation.OPER_PREPAY_RETAIL_CLIENT ------------------------------
      ...
      SELECT
        ...
        , ISNULL(l5.description, d.description) [OPER_PREPAY_RETAIL_CLIENT.Level5]
        , ISNULL(l4.description, ISNULL(l5.description, d.description)) [OPER_PREPAY_RETAIL_CLIENT.Level4]
        , ISNULL(l3.description, ISNULL(l4.description, ISNULL(l5.description, d.description))) [OPER_PREPAY_RETAIL_CLIENT.Level3]
        , ISNULL(l2.description, ISNULL(l3.description, ISNULL(l4.description, ISNULL(l5.description, d.description)))) [OPER_PREPAY_RETAIL_CLIENT.Level2]
        , ISNULL(l1.description, ISNULL(l2.description, ISNULL(l3.description, ISNULL(l4.description, ISNULL(l5.description, d.description))))) [OPER_PREPAY_RETAIL_CLIENT.Level1]
      FROM [Operation.OPER_PREPAY_RETAIL_CLIENT.v] d WITH (NOEXPAND)
        LEFT JOIN [Operation.OPER_PREPAY_RETAIL_CLIENT.v] l5 WITH (NOEXPAND) ON (l5.id = d.parent)
        LEFT JOIN [Operation.OPER_PREPAY_RETAIL_CLIENT.v] l4 WITH (NOEXPAND) ON (l4.id = l5.parent)
        LEFT JOIN [Operation.OPER_PREPAY_RETAIL_CLIENT.v] l3 WITH (NOEXPAND) ON (l3.id = l4.parent)
        LEFT JOIN [Operation.OPER_PREPAY_RETAIL_CLIENT.v] l2 WITH (NOEXPAND) ON (l2.id = l3.parent)
        LEFT JOIN [Operation.OPER_PREPAY_RETAIL_CLIENT.v] l1 WITH (NOEXPAND) ON (l1.id = l2.parent)
...
------------------------------ BEGIN Operation.GYM_SALES ------------------------------
      ...
      SELECT
        ...
        , ISNULL(l5.description, d.description) [GYM_SALES.Level5]
        , ISNULL(l4.description, ISNULL(l5.description, d.description)) [GYM_SALES.Level4]
        , ISNULL(l3.description, ISNULL(l4.description, ISNULL(l5.description, d.description))) [GYM_SALES.Level3]
        , ISNULL(l2.description, ISNULL(l3.description, ISNULL(l4.description, ISNULL(l5.description, d.description)))) [GYM_SALES.Level2]
        , ISNULL(l1.description, ISNULL(l2.description, ISNULL(l3.description, ISNULL(l4.description, ISNULL(l5.description, d.description))))) [GYM_SALES.Level1]
      FROM [Operation.GYM_SALES.v] d WITH (NOEXPAND)
        LEFT JOIN [Operation.GYM_SALES.v] l5 WITH (NOEXPAND) ON (l5.id = d.parent)
        LEFT JOIN [Operation.GYM_SALES.v] l4 WITH (NOEXPAND) ON (l4.id = l5.parent)
        LEFT JOIN [Operation.GYM_SALES.v] l3 WITH (NOEXPAND) ON (l3.id = l4.parent)
        LEFT JOIN [Operation.GYM_SALES.v] l2 WITH (NOEXPAND) ON (l2.id = l3.parent)
        LEFT JOIN [Operation.GYM_SALES.v] l1 WITH (NOEXPAND) ON (l1.id = l2.parent)
...
------------------------------ BEGIN Operation.LOAD_GYM_SMARTASS ------------------------------
      ...
      SELECT
        ...
        , ISNULL(l5.description, d.description) [LOAD_GYM_SMARTASS.Level5]
        , ISNULL(l4.description, ISNULL(l5.description, d.description)) [LOAD_GYM_SMARTASS.Level4]
        , ISNULL(l3.description, ISNULL(l4.description, ISNULL(l5.description, d.description))) [LOAD_GYM_SMARTASS.Level3]
        , ISNULL(l2.description, ISNULL(l3.description, ISNULL(l4.description, ISNULL(l5.description, d.description)))) [LOAD_GYM_SMARTASS.Level2]
        , ISNULL(l1.description, ISNULL(l2.description, ISNULL(l3.description, ISNULL(l4.description, ISNULL(l5.description, d.description))))) [LOAD_GYM_SMARTASS.Level1]
      FROM [Operation.LOAD_GYM_SMARTASS.v] d WITH (NOEXPAND)
        LEFT JOIN [Operation.LOAD_GYM_SMARTASS.v] l5 WITH (NOEXPAND) ON (l5.id = d.parent)
        LEFT JOIN [Operation.LOAD_GYM_SMARTASS.v] l4 WITH (NOEXPAND) ON (l4.id = l5.parent)
        LEFT JOIN [Operation.LOAD_GYM_SMARTASS.v] l3 WITH (NOEXPAND) ON (l3.id = l4.parent)
        LEFT JOIN [Operation.LOAD_GYM_SMARTASS.v] l2 WITH (NOEXPAND) ON (l2.id = l3.parent)
        LEFT JOIN [Operation.LOAD_GYM_SMARTASS.v] l1 WITH (NOEXPAND) ON (l1.id = l2.parent)
...
------------------------------ BEGIN Operation.LOAD_PREPAY_SMARTASS ------------------------------
      ...
      SELECT
        ...
        , ISNULL(l5.description, d.description) [LOAD_PREPAY_SMARTASS.Level5]
        , ISNULL(l4.description, ISNULL(l5.description, d.description)) [LOAD_PREPAY_SMARTASS.Level4]
        , ISNULL(l3.description, ISNULL(l4.description, ISNULL(l5.description, d.description))) [LOAD_PREPAY_SMARTASS.Level3]
        , ISNULL(l2.description, ISNULL(l3.description, ISNULL(l4.description, ISNULL(l5.description, d.description)))) [LOAD_PREPAY_SMARTASS.Level2]
        , ISNULL(l1.description, ISNULL(l2.description, ISNULL(l3.description, ISNULL(l4.description, ISNULL(l5.description, d.description))))) [LOAD_PREPAY_SMARTASS.Level1]
      FROM [Operation.LOAD_PREPAY_SMARTASS.v] d WITH (NOEXPAND)
        LEFT JOIN [Operation.LOAD_PREPAY_SMARTASS.v] l5 WITH (NOEXPAND) ON (l5.id = d.parent)
        LEFT JOIN [Operation.LOAD_PREPAY_SMARTASS.v] l4 WITH (NOEXPAND) ON (l4.id = l5.parent)
        LEFT JOIN [Operation.LOAD_PREPAY_SMARTASS.v] l3 WITH (NOEXPAND) ON (l3.id = l4.parent)
        LEFT JOIN [Operation.LOAD_PREPAY_SMARTASS.v] l2 WITH (NOEXPAND) ON (l2.id = l3.parent)
        LEFT JOIN [Operation.LOAD_PREPAY_SMARTASS.v] l1 WITH (NOEXPAND) ON (l1.id = l2.parent)
...
------------------------------ BEGIN Operation.Назначение ценового региона ------------------------------
      ...
      SELECT
        ...
        , ISNULL(l5.description, d.description) [Назначение ценового региона.Level5]
        , ISNULL(l4.description, ISNULL(l5.description, d.description)) [Назначение ценового региона.Level4]
        , ISNULL(l3.description, ISNULL(l4.description, ISNULL(l5.description, d.description))) [Назначение ценового региона.Level3]
        , ISNULL(l2.description, ISNULL(l3.description, ISNULL(l4.description, ISNULL(l5.description, d.description)))) [Назначение ценового региона.Level2]
        , ISNULL(l1.description, ISNULL(l2.description, ISNULL(l3.description, ISNULL(l4.description, ISNULL(l5.description, d.description))))) [Назначение ценового региона.Level1]
      FROM [Operation.Назначение ценового региона.v] d WITH (NOEXPAND)
        LEFT JOIN [Operation.Назначение ценового региона.v] l5 WITH (NOEXPAND) ON (l5.id = d.parent)
        LEFT JOIN [Operation.Назначение ценового региона.v] l4 WITH (NOEXPAND) ON (l4.id = l5.parent)
        LEFT JOIN [Operation.Назначение ценового региона.v] l3 WITH (NOEXPAND) ON (l3.id = l4.parent)
        LEFT JOIN [Operation.Назначение ценового региона.v] l2 WITH (NOEXPAND) ON (l2.id = l3.parent)
        LEFT JOIN [Operation.Назначение ценового региона.v] l1 WITH (NOEXPAND) ON (l1.id = l2.parent)
