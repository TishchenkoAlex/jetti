    ...
    GO
    CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.AccountablePersons.id] ON [Register.Accumulation.AccountablePersons.v]([id], [date]) WITH(ONLINE = ON);-- ON PS_month([date]);
    CREATE NONCLUSTERED COLUMNSTORE INDEX [Register.Accumulation.AccountablePersons] ON [Register.Accumulation.AccountablePersons.v]([id], [kind], [parent], [date], [document], [company], [calculated], [currency], [Employee], [CashFlow], [Amount], [AmountInBalance], [AmountInAccounting], [AmountToPay], [AmountIsPaid]) WITH(ONLINE = ON);-- ON PS_month([date]);
    GO
    ...
    GO
    CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.PaymentBatch.id] ON [Register.Accumulation.PaymentBatch.v]([id], [date]) WITH(ONLINE = ON);-- ON PS_month([date]);
    CREATE NONCLUSTERED COLUMNSTORE INDEX [Register.Accumulation.PaymentBatch] ON [Register.Accumulation.PaymentBatch.v]([id], [kind], [parent], [date], [document], [company], [calculated], [PaymentsKind], [Counterpartie], [ProductPackage], [Product], [Currency], [PayDay], [Qty], [Price], [Amount], [AmountInBalance], [batch]) WITH(ONLINE = ON);-- ON PS_month([date]);
    GO
    ...
    GO
    CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.Investment.Analytics.id] ON [Register.Accumulation.Investment.Analytics.v]([id], [date]) WITH(ONLINE = ON);-- ON PS_month([date]);
    CREATE NONCLUSTERED COLUMNSTORE INDEX [Register.Accumulation.Investment.Analytics] ON [Register.Accumulation.Investment.Analytics.v]([id], [kind], [parent], [date], [document], [company], [calculated], [Department], [SourceTransaction], [CreditTransaction], [OperationType], [Investor], [CompanyProduct], [Product], [Qty], [CurrencyProduct], [AmountProduct], [PaymentSource], [CurrencySource], [AmountSource], [CompanyLoan], [Loan], [CurrencyLoan], [AmountLoan]) WITH(ONLINE = ON);-- ON PS_month([date]);
    GO
    ...
    GO
    CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.OrderPayment.id] ON [Register.Accumulation.OrderPayment.v]([id], [date]) WITH(ONLINE = ON);-- ON PS_month([date]);
    CREATE NONCLUSTERED COLUMNSTORE INDEX [Register.Accumulation.OrderPayment] ON [Register.Accumulation.OrderPayment.v]([id], [kind], [parent], [date], [document], [company], [calculated], [PaymantKind], [Customer], [BankAccount], [CashRegister], [AcquiringTerminal], [currency], [Department], [CashShift], [Amount], [AmountInBalance], [AmountInAccounting]) WITH(ONLINE = ON);-- ON PS_month([date]);
    GO
    ...
    GO
    CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.AP.id] ON [Register.Accumulation.AP.v]([id], [date]) WITH(ONLINE = ON);-- ON PS_month([date]);
    CREATE NONCLUSTERED COLUMNSTORE INDEX [Register.Accumulation.AP] ON [Register.Accumulation.AP.v]([id], [kind], [parent], [date], [document], [company], [calculated], [currency], [Department], [AO], [Supplier], [PayDay], [Amount], [AmountInBalance], [AmountInAccounting], [AmountToPay], [AmountIsPaid]) WITH(ONLINE = ON);-- ON PS_month([date]);
    GO
    ...
    GO
    CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.AR.id] ON [Register.Accumulation.AR.v]([id], [date]) WITH(ONLINE = ON);-- ON PS_month([date]);
    CREATE NONCLUSTERED COLUMNSTORE INDEX [Register.Accumulation.AR] ON [Register.Accumulation.AR.v]([id], [kind], [parent], [date], [document], [company], [calculated], [currency], [Department], [AO], [Customer], [PayDay], [AR], [AmountInBalance], [AmountInAccounting], [AmountToPay], [AmountIsPaid]) WITH(ONLINE = ON);-- ON PS_month([date]);
    GO
    ...
    GO
    CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.Bank.id] ON [Register.Accumulation.Bank.v]([id], [date]) WITH(ONLINE = ON);-- ON PS_month([date]);
    CREATE NONCLUSTERED COLUMNSTORE INDEX [Register.Accumulation.Bank] ON [Register.Accumulation.Bank.v]([id], [kind], [parent], [date], [document], [company], [calculated], [currency], [BankAccount], [CashFlow], [Analytics], [Amount], [AmountInBalance], [AmountInAccounting]) WITH(ONLINE = ON);-- ON PS_month([date]);
    GO
    ...
    GO
    CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.Balance.id] ON [Register.Accumulation.Balance.v]([id], [date]) WITH(ONLINE = ON);-- ON PS_month([date]);
    CREATE NONCLUSTERED COLUMNSTORE INDEX [Register.Accumulation.Balance] ON [Register.Accumulation.Balance.v]([id], [kind], [parent], [date], [document], [company], [calculated], [Department], [Balance], [Analytics], [Amount], [Info]) WITH(ONLINE = ON);-- ON PS_month([date]);
    GO
    ...
    GO
    CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.Balance.RC.id] ON [Register.Accumulation.Balance.RC.v]([id], [date]) WITH(ONLINE = ON);-- ON PS_month([date]);
    CREATE NONCLUSTERED COLUMNSTORE INDEX [Register.Accumulation.Balance.RC] ON [Register.Accumulation.Balance.RC.v]([id], [kind], [parent], [date], [document], [company], [calculated], [ResponsibilityCenter], [Department], [Balance], [Analytics], [Analytics2], [Currency], [Amount], [AmountRC], [Info]) WITH(ONLINE = ON);-- ON PS_month([date]);
    GO
    ...
    GO
    CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.Balance.Report.id] ON [Register.Accumulation.Balance.Report.v]([id], [date]) WITH(ONLINE = ON);-- ON PS_month([date]);
    CREATE NONCLUSTERED COLUMNSTORE INDEX [Register.Accumulation.Balance.Report] ON [Register.Accumulation.Balance.Report.v]([id], [kind], [parent], [date], [document], [company], [calculated], [currency], [Department], [Balance], [Analytics], [Amount], [AmountInBalance], [AmountInAccounting], [Info]) WITH(ONLINE = ON);-- ON PS_month([date]);
    GO
    ...
    GO
    CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.Cash.id] ON [Register.Accumulation.Cash.v]([id], [date]) WITH(ONLINE = ON);-- ON PS_month([date]);
    CREATE NONCLUSTERED COLUMNSTORE INDEX [Register.Accumulation.Cash] ON [Register.Accumulation.Cash.v]([id], [kind], [parent], [date], [document], [company], [calculated], [currency], [CashRegister], [CashFlow], [Analytics], [Amount], [AmountInBalance], [AmountInAccounting]) WITH(ONLINE = ON);-- ON PS_month([date]);
    GO
    ...
    GO
    CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.Cash.Transit.id] ON [Register.Accumulation.Cash.Transit.v]([id], [date]) WITH(ONLINE = ON);-- ON PS_month([date]);
    CREATE NONCLUSTERED COLUMNSTORE INDEX [Register.Accumulation.Cash.Transit] ON [Register.Accumulation.Cash.Transit.v]([id], [kind], [parent], [date], [document], [company], [calculated], [CompanyRecipient], [currency], [Sender], [Recipient], [CashFlow], [Amount], [AmountInBalance], [AmountInAccounting]) WITH(ONLINE = ON);-- ON PS_month([date]);
    GO
    ...
    GO
    CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.Loan.id] ON [Register.Accumulation.Loan.v]([id], [date]) WITH(ONLINE = ON);-- ON PS_month([date]);
    CREATE NONCLUSTERED COLUMNSTORE INDEX [Register.Accumulation.Loan] ON [Register.Accumulation.Loan.v]([id], [kind], [parent], [date], [document], [company], [calculated], [Loan], [Counterpartie], [CashFlow], [currency], [PaymentKind], [Amount], [AmountInBalance], [AmountInAccounting], [AmountToPay], [AmountIsPaid]) WITH(ONLINE = ON);-- ON PS_month([date]);
    GO
    ...
    GO
    CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.PL.id] ON [Register.Accumulation.PL.v]([id], [date]) WITH(ONLINE = ON);-- ON PS_month([date]);
    CREATE NONCLUSTERED COLUMNSTORE INDEX [Register.Accumulation.PL] ON [Register.Accumulation.PL.v]([id], [kind], [parent], [date], [document], [company], [calculated], [Department], [PL], [Analytics], [Analytics2], [Amount], [Info]) WITH(ONLINE = ON);-- ON PS_month([date]);
    GO
    ...
    GO
    CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.PL.RC.id] ON [Register.Accumulation.PL.RC.v]([id], [date]) WITH(ONLINE = ON);-- ON PS_month([date]);
    CREATE NONCLUSTERED COLUMNSTORE INDEX [Register.Accumulation.PL.RC] ON [Register.Accumulation.PL.RC.v]([id], [kind], [parent], [date], [document], [company], [calculated], [ResponsibilityCenter], [Department], [PL], [Analytics], [Analytics2], [Currency], [Amount], [AmountRC], [Info]) WITH(ONLINE = ON);-- ON PS_month([date]);
    GO
    ...
    GO
    CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.Salary.id] ON [Register.Accumulation.Salary.v]([id], [date]) WITH(ONLINE = ON);-- ON PS_month([date]);
    CREATE NONCLUSTERED COLUMNSTORE INDEX [Register.Accumulation.Salary] ON [Register.Accumulation.Salary.v]([id], [kind], [parent], [date], [document], [company], [calculated], [currency], [KorrCompany], [Department], [Person], [Employee], [SalaryKind], [Analytics], [PL], [PLAnalytics], [Status], [IsPortal], [Amount], [AmountInBalance], [AmountInAccounting]) WITH(ONLINE = ON);-- ON PS_month([date]);
    GO
    ...
    GO
    CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.Depreciation.id] ON [Register.Accumulation.Depreciation.v]([id], [date]) WITH(ONLINE = ON);-- ON PS_month([date]);
    CREATE NONCLUSTERED COLUMNSTORE INDEX [Register.Accumulation.Depreciation] ON [Register.Accumulation.Depreciation.v]([id], [kind], [parent], [date], [document], [company], [calculated], [OperationType], [currency], [Department], [ResponsiblePerson], [OE], [Amount], [AmountInBalance], [AmountInAccounting]) WITH(ONLINE = ON);-- ON PS_month([date]);
    GO
    ...
    GO
    CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.BudgetItemTurnover.id] ON [Register.Accumulation.BudgetItemTurnover.v]([id], [date]) WITH(ONLINE = ON);-- ON PS_month([date]);
    CREATE NONCLUSTERED COLUMNSTORE INDEX [Register.Accumulation.BudgetItemTurnover] ON [Register.Accumulation.BudgetItemTurnover.v]([id], [kind], [parent], [date], [document], [company], [calculated], [Department], [Scenario], [BudgetItem], [Anatitic1], [Anatitic2], [Anatitic3], [Anatitic4], [Anatitic5], [currency], [Amount], [AmountInScenatio], [AmountInCurrency], [AmountInAccounting], [Qty]) WITH(ONLINE = ON);-- ON PS_month([date]);
    GO
    ...
    GO
    CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.Intercompany.id] ON [Register.Accumulation.Intercompany.v]([id], [date]) WITH(ONLINE = ON);-- ON PS_month([date]);
    CREATE NONCLUSTERED COLUMNSTORE INDEX [Register.Accumulation.Intercompany] ON [Register.Accumulation.Intercompany.v]([id], [kind], [parent], [date], [document], [company], [calculated], [Intercompany], [LegalCompanySender], [LegalCompanyRecipient], [Contract], [OperationType], [Analytics], [currency], [Amount], [AmountInBalance], [AmountInAccounting]) WITH(ONLINE = ON);-- ON PS_month([date]);
    GO
    ...
    GO
    CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.Acquiring.id] ON [Register.Accumulation.Acquiring.v]([id], [date]) WITH(ONLINE = ON);-- ON PS_month([date]);
    CREATE NONCLUSTERED COLUMNSTORE INDEX [Register.Accumulation.Acquiring] ON [Register.Accumulation.Acquiring.v]([id], [kind], [parent], [date], [document], [company], [calculated], [AcquiringTerminal], [AcquiringTerminalCode1], [OperationType], [Department], [CashFlow], [PaymantCard], [PayDay], [currency], [Amount], [AmountInBalance], [AmountOperation], [AmountPaid], [DateOperation], [DatePaid], [AuthorizationCode]) WITH(ONLINE = ON);-- ON PS_month([date]);
    GO
    ...
    GO
    CREATE UNIQUE CLUSTERED INDEX [Register.Accumulation.StaffingTable.id] ON [Register.Accumulation.StaffingTable.v]([id], [date]) WITH(ONLINE = ON);-- ON PS_month([date]);
    CREATE NONCLUSTERED COLUMNSTORE INDEX [Register.Accumulation.StaffingTable] ON [Register.Accumulation.StaffingTable.v]([id], [kind], [parent], [date], [document], [company], [calculated], [Department], [DepartmentCompany], [StaffingTablePosition], [Employee], [Person], [SalaryRate], [SalaryAnalytic], [currency], [Amount]) WITH(ONLINE = ON);-- ON PS_month([date]);
    GO
