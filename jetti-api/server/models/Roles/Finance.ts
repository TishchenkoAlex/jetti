...
export const FinanceRoleObject: RoleObject[] = [
  ...
  { type: 'Catalog.Counterpartie.BankAccount', read: true, write: true },
  { type: 'Catalog.Contract', read: true, write: true },
  { type: 'Catalog.BusinessDirection', read: true, write: true },
