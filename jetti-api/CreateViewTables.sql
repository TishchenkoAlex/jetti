    ...
    ALTER TABLE Documents DROP COLUMN IF EXISTS [Catalog.Loan.owner];
    ALTER TABLE Documents ADD [Catalog.Loan.owner] AS CAST(JSON_VALUE(doc, N'$."owner"') AS UNIQUEIDENTIFIER) PERSISTED;
    ...
    ALTER TABLE Documents DROP COLUMN IF EXISTS [Catalog.Loan.loanType];
    ALTER TABLE Documents ADD [Catalog.Loan.loanType] AS CAST(JSON_VALUE(doc, N'$."loanType"') AS UNIQUEIDENTIFIER) PERSISTED;
    ...
    CREATE UNIQUE NONCLUSTERED INDEX [Catalog.Loan.v.owner] ON [dbo].[Catalog.Loan.v]([owner], [id]);
    CREATE UNIQUE NONCLUSTERED INDEX [Catalog.Loan.v.currency] ON [dbo].[Catalog.Loan.v]([currency], [id]);
    CREATE UNIQUE NONCLUSTERED INDEX [Catalog.Loan.v.loanType] ON [dbo].[Catalog.Loan.v]([loanType], [id]);
